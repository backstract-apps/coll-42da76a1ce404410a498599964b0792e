...
app = FastAPI(title='Backstract Generated APIs - coll-42da76a1ce404410a498599964b0792e', debug=False,
              docs_url='/sad-leavitt-0e2b0bc642ca11f0a447020a7f64ac5060/docs',
              openapi_url='/sad-leavitt-0e2b0bc642ca11f0a447020a7f64ac5060/openapi.json')
...
app.include_router(
    router,
    prefix='/sad-leavitt-0e2b0bc642ca11f0a447020a7f64ac5060/api',
    tags=['APIs v1']
)
